...
def plot_recos_with_diff_params(params, sinogram, output_img_fn):
    ...
    for i in range(n_row):
        for j in range(n_col):
            ...
            # ray_obj = odl.tomo.RayTransform(RECO_SPACE, geom_with_par(par), impl='astra_cpu')
            ...
            axs[i, j].set_title(rf"$\alpha_0=$ {par[0]:.2f}, $r_D=$ {par[1]:.2f}" + "\n" +
                                ...
                                rf"$\alpha_D=$ {par[4]:.2f}", fontsize=16)
